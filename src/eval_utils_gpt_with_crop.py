...
def format_explore_prompt(
    ...
    text += "Snapshot: A focused observation of several objects. It contains a full image of the cluster of objects, and separate image crops of each object. " + \
            "Choosing a snapshot means that you are selecting the observed objects in the snapshot as the target objects to help answer the question. " + \
            "Therefore, if you choose a snapshot, you should also choose an object in the snapshot that you think is the best helpful for answering the question.\n"
