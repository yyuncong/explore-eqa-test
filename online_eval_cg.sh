...
#SBATCH -o output/cg_%j.out
#SBATCH -e output/cg_%j.err
#SBATCH --mem=128G
#SBATCH --nodes=1
...
python online_evaluation_openeqa_dynamic_cg_baseline.py \
-cf cfg/online_eval_openeqa_dynamic_cg_baseline.yaml \
